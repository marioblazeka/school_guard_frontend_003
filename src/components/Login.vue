    ...
    <div class="card shadow-lg border-0 p-4 auth-card">
      <div class="card-body">
        ...
        <div class="text-center mb-4">
          ...
          <p class="text-muted small">Prijavite se u sustav za praćenje</p>
        </div>
        ...
        <!-- Dodatni linkovi iz prošlog dropdowna prebačeni u formu -->
        <div class="text-center pt-2 border-top">
          <router-link to="/signup" class="d-block small text-decoration-none mb-1 text-primary">
...
<style scoped>
/* Osigurava da je forma centrirana na ekranu i ne bježi pod donji izbornik */
.auth-page {
...
/* Prilagodba Bootstrap primarne boje u Vue zelenu */
.btn-primary {
